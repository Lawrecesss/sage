...
| Area | Path |
| --- | --- |
| Routes | `web/src/app/{page,layout}.tsx`, `app/{signals,ask,connections}/page.tsx` |
| Components | `web/src/components/{brief,signals,ask,ui}/` |
| Contract types | `web/src/lib/types.ts` |
| API client | `web/src/lib/api-client.ts` |
| Design tokens | `web/src/app/globals.css`, `web/tailwind.config.ts` |
...
- [ ] **🔒 Freeze brief-JSON types with M2** — `web/src/lib/types.ts` mirroring
...
- [ ] **Design system** — `web/src/app/globals.css`, `web/tailwind.config.ts`
...
- [ ] **Static Morning Brief** — `web/src/app/page.tsx`,
      `web/src/components/brief/*` (`BriefCard.tsx`, `SeverityBadge.tsx`,
...
- [ ] **Live Morning Brief** — `web/src/app/page.tsx`
...
- [ ] **Signals list** — `web/src/app/signals/page.tsx`,
...
- [ ] **Ask chat** — `web/src/app/ask/page.tsx`, `web/src/components/ask/*`
...
- [ ] **Connections visual** — `web/src/app/connections/page.tsx`
