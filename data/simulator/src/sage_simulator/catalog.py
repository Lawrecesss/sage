...
`Sku`'s shape lives in `sage_models` (shared with every other service); this
module only builds instances of it. `build_catalog(config, suppliers)` returns a
deterministic `tuple[Sku, ...]` of
...
from sage_models import Sku, Supplier

from .config import GeneratorConfig
from .rng import substream
from .suppliers import suppliers_by_category
